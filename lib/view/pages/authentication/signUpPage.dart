        ...
        builder: (context, model, child) =>baseUi(children: [
          ...
          rowPositioned(
              child: GeneralTextDisplay(
                  "SignUp to Cardizerr", secondaryColor, 1, 20, FontWeight.w700, "login"),
              top: 200),
          // sign up
          rowPositioned(
              child: GestureDetector(
                ...
                child: Row(
                  children: [
                    GeneralTextDisplay("Already have an account? ", black51, 1, 16,
          ...
          rowPositioned(
              child:
              textAndTextField(context, textInputType: TextInputType.text,
                  controller: model.passwordController, hint: "Enter a secured password",
